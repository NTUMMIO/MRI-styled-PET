...
def tester():
    ...
    for iteration, data in enumerate(testloader, 1):
        ...
        if args.fusion_op == False:
            PET_preds, MRI_preds = model_conversion(fusion_output)
...
def _prepare_data(mode):
    ...
    #===============================================
        ...
        #===============================================
        test_dataset = ADNIDataset(root0=PET_test_filenames, root1=MRI_test_filenames, transform=trns.Compose([trns.ToTensor()]))
